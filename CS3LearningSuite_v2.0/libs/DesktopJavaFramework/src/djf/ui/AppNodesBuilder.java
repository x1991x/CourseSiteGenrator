...
public class AppNodesBuilder {
    ...
    public ImageView buildImageView(Object nodeId,
        ...
        initNode(nodeId, imageView, parentPane, styleClass, enabled);
        return imageView;
    }
    ...
    public TabPane buildTabPane(Object nodeId,
        ...
        initNode(nodeId, tabPane, parentPane, styleClass, enabled);
        return tabPane;
    }
    public ScrollPane buildScrollPane(Object nodeId,
            Pane parentPane,
            String styleClass,
            boolean enabled) {
        ScrollPane scrollPane = new ScrollPane();
        initNode(nodeId, scrollPane, parentPane, styleClass, enabled);
        return scrollPane;
    }
    ...
    public TextArea buildTextArea(Object nodeId,
        ...
        initNode(nodeId, texArea, parentPane, styleClass, enabled);
        return texArea;
    }
