...
public enum AppPropertyType {
    ...
    APP_PATH_CSS,
    APP_PATH_EXPORT,
    APP_PATH_STYLE_SHEET,
    APP_PATH_LOCAL_CSS,
    APP_PATH_EXPORT_DATA,
    APP_PATH_EXPORT_DATA_IMAGES,
    APP_PATH_EXPORT_DATA_CSS,
    APP_PATH_APP_DATA,
    APP_PATH_IMAGES,
    APP_PATH_EXPORT_IMAGES,
    APP_PATH_ICONS,
    APP_PATH_WEB,
    WORK_FILE_EXT,
    WORK_FILE_EXT_DESC,
    ...
    NO_PAGE_SELECTED_TITLE, NO_PAGE_SELECTED_CONTENT,
    // HELP/ABOUT DIALOGS
