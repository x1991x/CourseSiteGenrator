...
public class TADialog extends Stage {
    ...
    public TADialog(CourseSiteGeneratorApp initApp) {
    ...
    private void processDataChange() {
        ...
        CourseSiteGeneratorFoolproofDesign fP = new CourseSiteGeneratorFoolproofDesign(app);
    ...
    private void processCompleteWork() {
        ...
        EditTA_Transaction transaction = new EditTA_Transaction(taToEdit, data, name, email, type.toString());
